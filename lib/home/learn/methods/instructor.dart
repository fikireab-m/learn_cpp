...
class InstructorSimulator extends StatefulWidget {
  const InstructorSimulator({Key? key}) : super(key: key);

  @override
  _InstructorSimulatorState createState() => _InstructorSimulatorState();
}

enum TtsState { playing, stopped, paused, continued }

class _InstructorSimulatorState extends State<InstructorSimulator> {
